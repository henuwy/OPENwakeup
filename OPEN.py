...
str1=r'openapp.jdmobile://virtual?params={"category":"jump","des":"m","url":"'
str2=r'","m_param":{"jdv":"'
str3=r'"},"kepler_param":{"source":"kepler-open","channel":"'
str4=r'"},"keplerFrom":"1","keplerID":"'
str5=r'"}'
# chromedriver =r'D:\E\Chrome Downloads\TEMP\chromedriver_win32\chromedriver.exe'
...
for row in islice(csv_data, 1, None):
    ...
    for cookie in driver.get_cookies():
        if cookie['name']=='__jdv':
            ...
            print(tstr1[0])
            a=str1 + ttttttt + str2 + tstr1[0] + str3 +row[5] +str4 +row[4]+str5
            row[3]=tstr1[0]
            row[6]=a
